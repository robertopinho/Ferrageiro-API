...
def alterar(id):
    ...
    cliente.enderecoBairro = request.json['enderecoBairro']
    cliente.enderecoComplemento = request.json['enderecoComplemento']
    cliente.enderecoLogradouro = request.json['enderecoLogradouro']
    cliente.enderecoNumero = request.json['enderecoNumero']
    cliente.enderecoTipo = request.json['enderecoTipo']
