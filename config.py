class config:
    ...
    SQLALCHEMY_DATABASE_URI = 'mysql+pymysql://root@localhost/ferragem'
    # SQLALCHEMY_DATABASE_URI = 'robertoopinho:ferragem@robertoopinho.mysql.pythonanywhere-services.com/robertoopinho$ferragem';
